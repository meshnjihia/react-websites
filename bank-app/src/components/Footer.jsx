...
const Footer = () => 
  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    ...
    <div className="flex w-full justify-between items-center md:flex-row flex-col pt-6 border-t border-[#3f3e45]">
      <p className="text-center font-poppins font-normal text-[18px] leading-[27px] text-white ">
